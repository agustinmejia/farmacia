...
@section('page_title', 'Agregar inventario')

@section('page_header')
    <div class="container-fluid">
        <h1 class="page-title">
            <i class="voyager-data"></i> Agregar inventario
        </h1>
    </div>
@stop
                        ...
                        <form action="{{ route('inventario.store') }}" method="post">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>Precio</label>
                                        <input type="number" name="precio" min="0.5" step="0.1" class="form-control" value="" placeholder="Precio del producto" required>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>Stock</label>
